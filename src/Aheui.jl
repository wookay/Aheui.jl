...
function 뽑기(저장::스택, ::Int)
  isempty(저장.공간) ? nothing : 출력(저장, 뽑(저장))
end
뽑기(저장::저장공간, _) = 출력(저장, 뽑(저장))

출력(저장::저장공간, 값) = push!(저장.출력, 값)

function 집어넣기(저장::저장공간, ::Symbol)
...
집어넣기(저장::저장공간, 값::Int) = push!(저장.공간, 값)

중복(저장::스택, _) = 집어넣기(저장, last(저장.공간))
중복(저장::저장공간, _) = 집어넣기(저장, last(저장.공간))

바꿔치기(저장::스택, _) = 저장.공간[end], 저장.공간[end-1] = 저장.공간[end-1], 저장.공간[end]
바꿔치기(저장::저장공간, _) = nothing
